...
Couchbase.prototype.updateAttributes = function(model, id, data, options, cb) {
...
Couchbase.prototype.update = function(model, where, data, options, cb) {
  ...
  this._executeAlteringQuery(model, stmt.sql, params, options, cb || NOOP);
};
