...
//   this._replace(model, where, data, options, callback);
// };

// Couchbase.prototype._constructUpdateQuery = function(model, where, fields) {
//   let self = this;
//   const settings = self.settings;

//   let updateClause = new ParameterizedSQL('UPDATE ' + this.tableEscaped(model));
